    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duplicated_page', models.OneToOneField(help_text='The duplicated Baserow page.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='duplicated_from_jobs', to='builder.page')),
                ('original_page', models.ForeignKey(help_text='The baserow page to duplicate.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='duplicated_by_jobs', to='builder.page')),
            ],
            options={
                'abstract': False,
            },
