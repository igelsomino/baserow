...
FORMULA_NOW_PERIODIC_TASK_INTERVAL_MINUTES = int(
    os.getenv("BASEROW_FORMULA_NOW_PERIODIC_TASK_INTERVAL_MINUTES", 1)
)
FORMULA_NOW_MIN_TIME_BETWEEN_UPDATES_SECONDS = int(
    os.getenv("BASEROW_FORMULA_NOW_PERIODIC_TASK_INTERVAL_MINUTES", 30)
)
